namespace Code.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Code.DAL.dbcontext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "Code.DAL.dbcontext";
        }

        protected override void Seed(Code.DAL.dbcontext context)
        {
